...
namespace RDFSharp.Store
{
    ...
    internal static class RDFNQuads
    {
        ...
        /// </summary>
        internal static readonly Lazy<Regex> SPLC_PLANG = new Lazy<Regex>(() => new Regex($@"^<[^<>\s]+>\s*<[^<>\s]+>\s*\""(.)*\""@{RDFPlainLiteral.LangTagMask}\s*<[^<>\s]+>\s*\.$", RegexOptions.Compiled));
        ...
        /// </summary>
        internal static readonly Lazy<Regex> BPLC_PLANG = new Lazy<Regex>(() => new Regex($@"^_:[^<>\s]+\s*<[^<>\s]+>\s*\""(.)*\""@{RDFPlainLiteral.LangTagMask}\s*<[^<>\s]+>\s*\.$", RegexOptions.Compiled));
