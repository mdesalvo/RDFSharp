...
namespace RDFSharp.Query
{
    ...
    public class RDFSumAggregator : RDFAggregator
    {
        ...
        {
            return String.Format("(SUM({0}) AS {1})", this.AggregatorVariable, this.ProjectionVariable);
        }
        #endregion

        #region Methods
        /// <summary>
        /// Executes the SUM aggregator function on the given tablerow
        /// </summary>
        ...
        /// <summary>
        /// Finalizes the SUM aggregator function on the result table
        /// </summary>
