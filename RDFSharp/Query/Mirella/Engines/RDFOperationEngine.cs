                            ...
                            case RDFQueryEnums.RDFClearOperationFlavor.NAMED:
                                deleteWhereOperation
                                    .AddPatternGroup(new RDFPatternGroup()
                                        ...
                                        .AddFilter(new RDFExpressionFilter(new RDFNotExpression(new RDFSameTermExpression(new RDFVariable("C"), new RDFConstantExpression(new RDFResource(RDFNamespaceRegister.DefaultNamespace.NamespaceUri.ToString())))))))
