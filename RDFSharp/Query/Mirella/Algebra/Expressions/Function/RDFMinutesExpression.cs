...
namespace RDFSharp.Query
{
    ...
    /// </summary>
    public class RDFMinutesExpression : RDFExpression
    {
        #region Ctors
        /// <summary>
        /// Default-ctor to build a datetime minutes function with given arguments
        /// </summary>
        public RDFMinutesExpression(RDFExpression leftArgument) : base(leftArgument, null as RDFExpression) { }

        /// <summary>
        /// Default-ctor to build a datetime minutes function with given arguments
        /// </summary>
        public RDFMinutesExpression(RDFVariable leftArgument) : base(leftArgument, null as RDFExpression) { }
        #endregion

        #region Interfaces
        /// <summary>
        /// Gives the string representation of the datetime minutes function
        /// </summary>
        ...
        #region Methods
        /// <summary>
        /// Applies the datetime minutes function on the given datarow
        /// </summary>
