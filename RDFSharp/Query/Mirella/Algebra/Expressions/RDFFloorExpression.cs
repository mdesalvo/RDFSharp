...
namespace RDFSharp.Query
{
    ...
    public class RDFFloorExpression : RDFExpression
    {
        ...
        #region Interfaces
        /// <summary>
        /// Gives the string representation of the arithmetical floor function
        /// </summary>
        ...
        #region Methods
        /// <summary>
        /// Applies the arithmetical floor function on the given datarow
        /// </summary>
            ...
            try
            {
                     ...
                     && leftArgumentTypedLiteral.HasDecimalDatatype())
                {
                    ...
                    if (leftArgumentTypedLiteral.Datatype.TargetDatatype == RDFModelEnums.RDFDatatypes.OWL_RATIONAL)
                        expressionResult = new RDFTypedLiteral(Convert.ToString(Math.Floor(RDFModelUtilities.ComputeOWLRationalValue(leftArgumentTypedLiteral)), CultureInfo.InvariantCulture), RDFModelEnums.RDFDatatypes.XSD_DOUBLE);
                        ...
                        expressionResult = new RDFTypedLiteral(Convert.ToString(Math.Floor(leftArgumentNumericValue), CultureInfo.InvariantCulture), RDFModelEnums.RDFDatatypes.XSD_DOUBLE);
                }
                #endregion
            }
