...
{
    /// <summary>
    /// RDFStrAfterExpression represents a string "after" function to be applied on a query results table.
    /// </summary>
    public sealed class RDFStrAfterExpression : RDFExpression
    {
        #region Ctors
        /// <summary>
        /// Builds a string "after" function with given arguments
        /// </summary>
        public RDFStrAfterExpression(RDFExpression leftArgument, RDFExpression rightArgument) : base(leftArgument, rightArgument) { }

        /// <summary>
        /// Builds a string "after" function with given arguments
        /// </summary>
        public RDFStrAfterExpression(RDFExpression leftArgument, RDFVariable rightArgument) : base(leftArgument, rightArgument) { }

        /// <summary>
        /// Builds a string "after" function with given arguments
        /// </summary>
        public RDFStrAfterExpression(RDFVariable leftArgument, RDFExpression rightArgument) : base(leftArgument, rightArgument) { }

        /// <summary>
        /// Builds a string "after" function with given arguments
        /// </summary>
        public RDFStrAfterExpression(RDFVariable leftArgument, RDFVariable rightArgument) : base(leftArgument, rightArgument) { }
        #endregion

        #region Interfaces
        /// <summary>
        /// Gives the string representation of the string "after" function
        /// </summary>
        ...
        #region Methods
        /// <summary>
        /// Applies the string "after" function on the given datarow
        /// </summary>
        internal override RDFPatternMember ApplyExpression(RDFTableRow row)
        {
            ...
            try
            {
                ...
                //The "source" (left) is kept as a plain literal preserving its language, since SPARQL STRAFTER
