...
namespace RDFSharp.Query
{
    ...
    /// </summary>
    public class RDFYearExpression : RDFExpression
    {
        #region Ctors
        /// <summary>
        /// Default-ctor to build a datetime year function with given arguments
        /// </summary>
        public RDFYearExpression(RDFExpression leftArgument) : base(leftArgument, null as RDFExpression) { }

        /// <summary>
        /// Default-ctor to build a datetime year function with given arguments
        /// </summary>
        public RDFYearExpression(RDFVariable leftArgument) : base(leftArgument, null as RDFExpression) { }
        #endregion

        #region Interfaces
        /// <summary>
        /// Gives the string representation of the datetime year function
        /// </summary>
        ...
        #region Methods
        /// <summary>
        /// Applies the datetime year function on the given datarow
        /// </summary>
