...
namespace RDFSharp.Query
{
    ...
    /// </summary>
    public class RDFSecondsExpression : RDFExpression
    {
        #region Ctors
        /// <summary>
        /// Default-ctor to build a datetime seconds function with given arguments
        /// </summary>
        public RDFSecondsExpression(RDFExpression leftArgument) : base(leftArgument, null as RDFExpression) { }

        /// <summary>
        /// Default-ctor to build a datetime seconds function with given arguments
        /// </summary>
        public RDFSecondsExpression(RDFVariable leftArgument) : base(leftArgument, null as RDFExpression) { }
        #endregion

        #region Interfaces
        /// <summary>
        /// Gives the string representation of the datetime seconds function
        /// </summary>
        ...
        #region Methods
        /// <summary>
        /// Applies the datetime seconds function on the given datarow
        /// </summary>
