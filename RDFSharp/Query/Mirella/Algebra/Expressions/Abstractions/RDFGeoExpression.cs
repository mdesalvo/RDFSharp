...
public abstract class RDFGeoExpression : RDFExpression
{
    ...
    internal override RDFPatternMember ApplyExpression(DataRow row)
    {
        ...
        if (LeftArgument is RDFVariable lv && !row.Table.Columns.Contains(lv.ToString()))
            return null;
        if (RightArgument is RDFVariable rv && !row.Table.Columns.Contains(rv.ToString()))
            return null;
        #endregion
        ...
        try
        {
            ...
            RDFPatternMember rightArgumentPMember = RightArgument switch
            {
                ...
                RDFVariable => RDFQueryUtilities.ParseRDFPatternMember(row[RightArgument.ToString()].ToString()),
                ...
                && leftArgumentTypedLiteral.HasGeographicDatatype())
            {
                ...
                switch (this)
                {
                    ...
                    case RDFGeoDimensionExpression:
                    ...
                    {
                        bool sfEgenhoferRelate = geoEgenhoferExpression.EgenhoferRelation switch
                        {
                            RDFQueryEnums.RDFGeoEgenhoferRelations.Contains => leftGeometryLAZ.Relate(rightGeometryLAZ,
                                "T*TFF*FF*"),
                            RDFQueryEnums.RDFGeoEgenhoferRelations.CoveredBy => leftGeometryLAZ.Relate(rightGeometryLAZ,
                                "TFF*TFT**"),
                            RDFQueryEnums.RDFGeoEgenhoferRelations.Covers => leftGeometryLAZ.Relate(rightGeometryLAZ,
                                "T*TFT*FF*"),
                            RDFQueryEnums.RDFGeoEgenhoferRelations.Disjoint => leftGeometryLAZ.Relate(rightGeometryLAZ,
                                "FF*FF****"),
                            RDFQueryEnums.RDFGeoEgenhoferRelations.Equals => leftGeometryLAZ.Relate(rightGeometryLAZ,
                                "TFFFTFFFT"),
                            RDFQueryEnums.RDFGeoEgenhoferRelations.Inside => leftGeometryLAZ.Relate(rightGeometryLAZ,
                                "TFF*FFT**"),
                            RDFQueryEnums.RDFGeoEgenhoferRelations.Meet =>
                                leftGeometryLAZ.Relate(rightGeometryLAZ, "FT*******") ||
                                leftGeometryLAZ.Relate(rightGeometryLAZ, "F**T*****") ||
                                leftGeometryLAZ.Relate(rightGeometryLAZ, "F***T****"),
                            RDFQueryEnums.RDFGeoEgenhoferRelations.Overlap => leftGeometryLAZ.Relate(rightGeometryLAZ,
                                "T*T***T**"),
                            _ => false
                        };
                    ...
                    case RDFGeoGetSRIDExpression:
                        ...
                        break;
                    case RDFGeoIntersectionExpression:
                    {
                    ...
                    {
                        bool sfRCSS8Relate = geoRCC8Expression.RCC8Relation switch
                        {
                            RDFQueryEnums.RDFGeoRCC8Relations.RCC8DC => leftGeometryLAZ.Relate(rightGeometryLAZ,
                                "FFTFFTTTT"),
                            RDFQueryEnums.RDFGeoRCC8Relations.RCC8EC => leftGeometryLAZ.Relate(rightGeometryLAZ,
                                "FFTFTTTTT"),
                            RDFQueryEnums.RDFGeoRCC8Relations.RCC8EQ => leftGeometryLAZ.Relate(rightGeometryLAZ,
                                "TFFFTFFFT"),
                            RDFQueryEnums.RDFGeoRCC8Relations.RCC8NTPP => leftGeometryLAZ.Relate(rightGeometryLAZ,
                                "TFFTFFTTT"),
                            RDFQueryEnums.RDFGeoRCC8Relations.RCC8NTPPI => leftGeometryLAZ.Relate(rightGeometryLAZ,
                                "TTTFFTFFT"),
                            RDFQueryEnums.RDFGeoRCC8Relations.RCC8PO => leftGeometryLAZ.Relate(rightGeometryLAZ,
                                "TTTTTTTTT"),
                            RDFQueryEnums.RDFGeoRCC8Relations.RCC8TPP => leftGeometryLAZ.Relate(rightGeometryLAZ,
                                "TFFTTFTTT"),
                            RDFQueryEnums.RDFGeoRCC8Relations.RCC8TPPI => leftGeometryLAZ.Relate(rightGeometryLAZ,
                                "TTTFTTFFT"),
                            _ => false
                        };
                    ...
                    case RDFGeoRelateExpression geoRelateExpression:
                        ...
                        break;
                    case RDFGeoSymDifferenceExpression:
                    {
