...
namespace RDFSharp.Query
{
    ...
    /// </summary>
    public class RDFSHA512Expression : RDFExpression
    {
        #region Ctors
        /// <summary>
        /// Default-ctor to build a SHA512 hash function with given arguments
        /// </summary>
        ...
        internal override RDFPatternMember ApplyExpression(DataRow row)
        {
            ...
            try
            {
                ...
                {
                    byte[] hashBytes = SHA512Encryptor.ComputeHash(RDFModelUtilities.UTF8_NoBOM.GetBytes(leftArgumentPMember.ToString()));
                    StringBuilder sb = new StringBuilder();
