...
namespace RDFSharp.Query
{
    ...
    public sealed class RDFBooleanAndFilter : RDFFilter
    {
        ...
        {
            LeftFilter = leftFilter ?? throw new RDFQueryException("Cannot create RDFBooleanAndFilter because given \"leftFilter\" parameter is null.");
            RightFilter = rightFilter ?? throw new RDFQueryException("Cannot create RDFBooleanAndFilter because given \"rightFilter\" parameter is null.");
        }
        #endregion
