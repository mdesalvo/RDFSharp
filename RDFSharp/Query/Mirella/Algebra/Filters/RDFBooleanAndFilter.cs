...
public sealed class RDFBooleanAndFilter : RDFFilter
{
    ...
    #region Ctors
    /// <summary>
    /// Builds an "AND" filter on the given filters
    /// </summary>
    ...
    public RDFBooleanAndFilter(RDFFilter leftFilter, RDFFilter rightFilter)
    {
        switch (leftFilter)
        {
            ...
            case RDFExistsFilter:
                throw new RDFQueryException("Cannot create RDFBooleanAndFilter because given \"leftFilter\" parameter is of type RDFExistsFilter: this is not supported.");
        }
        switch (rightFilter)
        {
            case null:
            ...
            case RDFExistsFilter:
                throw new RDFQueryException("Cannot create RDFBooleanAndFilter because given \"rightFilter\" parameter is of type RDFExistsFilter: this is not supported.");
            default:
