...
namespace RDFSharp.Semantics.OWL
{
    ...
    /// </summary>
    public class RDFOntologyReasonerRuleContainsIgnoreCaseBuiltIn : RDFOntologyReasonerRuleFilterBuiltIn
    {
        #region Properties
        /// <summary>
        ...
        /// </summary>
        public RDFOntologyReasonerRuleContainsIgnoreCaseBuiltIn(RDFVariable leftArgument, string containString)
