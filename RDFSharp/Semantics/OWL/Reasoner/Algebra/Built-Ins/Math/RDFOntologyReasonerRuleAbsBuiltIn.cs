...
namespace RDFSharp.Semantics.OWL
{
    ...
    /// </summary>
    public class RDFOntologyReasonerRuleAbsBuiltIn : RDFOntologyReasonerRuleMathBuiltIn
    {
        #region Properties
        /// <summary>
        /// Represents the Uri of the built-in (swrlb:abs)
        /// </summary>
        private static RDFResource BuiltInUri = new RDFResource($"swrlb:abs");
        #endregion
        ...
        /// </summary>
        public RDFOntologyReasonerRuleAbsBuiltIn(RDFVariable leftArgument, RDFVariable rightArgument)
