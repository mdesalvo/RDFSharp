...
namespace RDFSharp.Semantics.OWL
{
    ...
    /// </summary>
    public class RDFOntologyReasonerRuleCosBuiltIn : RDFOntologyReasonerRuleMathBuiltIn
    {
        #region Properties
        /// <summary>
        /// Represents the Uri of the built-in (swrlb:cos)
        /// </summary>
        private static RDFResource BuiltInUri = new RDFResource($"swrlb:cos");
        #endregion
        ...
        /// </summary>
        public RDFOntologyReasonerRuleCosBuiltIn(RDFVariable leftArgument, RDFVariable rightArgument)
