...
namespace RDFSharp.Semantics.OWL
{
    ...
    /// </summary>
    public class RDFOntologyReasonerRuleFloorBuiltIn : RDFOntologyReasonerRuleMathBuiltIn
    {
        #region Properties
        /// <summary>
        /// Represents the Uri of the built-in (swrlb:floor)
        /// </summary>
        private static RDFResource BuiltInUri = new RDFResource($"swrlb:floor");
        #endregion
        ...
        /// </summary>
        public RDFOntologyReasonerRuleFloorBuiltIn(RDFVariable leftArgument, RDFVariable rightArgument)
