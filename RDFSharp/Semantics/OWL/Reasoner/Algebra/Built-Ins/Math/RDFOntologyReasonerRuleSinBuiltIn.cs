...
namespace RDFSharp.Semantics.OWL
{
    ...
    /// </summary>
    public class RDFOntologyReasonerRuleSinBuiltIn : RDFOntologyReasonerRuleMathBuiltIn
    {
        #region Properties
        /// <summary>
        /// Represents the Uri of the built-in (swrlb:sin)
        /// </summary>
        private static RDFResource BuiltInUri = new RDFResource($"swrlb:sin");
        #endregion
        ...
        /// </summary>
        public RDFOntologyReasonerRuleSinBuiltIn(RDFVariable leftArgument, RDFVariable rightArgument)
