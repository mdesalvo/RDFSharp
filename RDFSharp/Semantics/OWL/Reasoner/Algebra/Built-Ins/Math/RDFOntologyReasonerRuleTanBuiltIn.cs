...
namespace RDFSharp.Semantics.OWL
{
    ...
    /// </summary>
    public class RDFOntologyReasonerRuleTanBuiltIn : RDFOntologyReasonerRuleMathBuiltIn
    {
        #region Properties
        /// <summary>
        /// Represents the Uri of the built-in (swrlb:tan)
        /// </summary>
        private static RDFResource BuiltInUri = new RDFResource($"swrlb:tan");
        #endregion
        ...
        /// </summary>
        public RDFOntologyReasonerRuleTanBuiltIn(RDFVariable leftArgument, RDFVariable rightArgument)
