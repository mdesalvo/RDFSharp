...
namespace RDFSharp.Semantics.OWL
{
    ...
    /// </summary>
    public class RDFOntologyReasonerRuleLessOrEqualThanBuiltIn : RDFOntologyReasonerRuleBuiltIn
    {
        #region Properties
        /// <summary>
        /// Represents the Uri of the built-in (swrlb:lessThanOrEqual)
        /// </summary>
        private static RDFResource BuiltInUri = new RDFResource($"{RDFVocabulary.SWRL.SWRLB.PREFIX}:lessThanOrEqual");
        #endregion
