...
namespace RDFSharp.Semantics.OWL
{
    ...
    /// </summary>
    public class RDFOntologyReasonerRuleGreaterThanOrEqualBuiltIn : RDFOntologyReasonerRuleBuiltIn
    {
        #region Properties
        /// <summary>
        /// Represents the Uri of the built-in (swrlb:greaterThanOrEqual)
        /// </summary>
        private static RDFResource BuiltInUri = new RDFResource($"{RDFVocabulary.SWRL.SWRLB.PREFIX}:greaterThanOrEqual");
        #endregion
