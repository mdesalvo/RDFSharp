...
namespace RDFSharp.Model
{
    ...
    {
        #region Statics
        private static Dictionary<string, RDFModelEnums.RDFDatatypes> DatatypeStringMapper { get; set; }
        static RDFModelUtilities()
            => DatatypeStringMapper = new Dictionary<string, RDFModelEnums.RDFDatatypes>()
               {
