...
namespace RDFSharp.Test.Model
{
    ...
    public class RDFContainerTest
    {
        ...
        public void ShouldReifyEmptyContainer(RDFModelEnums.RDFContainerTypes containerType, RDFModelEnums.RDFItemTypes itemType)
        {
            ...
            {
                case RDFModelEnums.RDFContainerTypes.Alt:
                    Assert.IsTrue(graph.IndexedTriples.ContainsKey(new RDFTriple(cont.ReificationSubject, RDFVocabulary.RDF.TYPE, RDFVocabulary.RDF.ALT).TripleID));
                    break;
                case RDFModelEnums.RDFContainerTypes.Bag:
                    ...
                    break;
                case RDFModelEnums.RDFContainerTypes.Seq:
                    Assert.IsTrue(graph.IndexedTriples.ContainsKey(new RDFTriple(cont.ReificationSubject, RDFVocabulary.RDF.TYPE, RDFVocabulary.RDF.SEQ).TripleID));
                    break;
            }
        }
