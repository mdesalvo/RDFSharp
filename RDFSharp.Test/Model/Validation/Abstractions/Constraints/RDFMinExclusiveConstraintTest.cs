...
{
    [TestClass]
    public class RDFMinExclusiveConstraintTest
    {
        #region Tests
        [TestMethod]
        public void ShouldCreateMinExclusiveResourceConstraint()
        {
            RDFMinExclusiveConstraint minExclusiveConstraint = new RDFMinExclusiveConstraint(new RDFResource("ex:value"));

            Assert.IsNotNull(minExclusiveConstraint);
            Assert.IsTrue(minExclusiveConstraint.Value.Equals(new RDFResource("ex:value")));
        }

        [TestMethod]
        public void ShouldThrowExceptionOnCreatingMinExclusiveResourceConstraint()
            => Assert.ThrowsException<RDFModelException>(() => new RDFMinExclusiveConstraint(null as RDFResource));

        [TestMethod]
        public void ShouldExportMinExclusiveResourceConstraint()
        {
            RDFMinExclusiveConstraint minExclusiveConstraint = new RDFMinExclusiveConstraint(new RDFResource("ex:value"));
            RDFGraph graph = minExclusiveConstraint.ToRDFGraph(new RDFNodeShape(new RDFResource("ex:NodeShape")));

            Assert.IsNotNull(graph);
            Assert.IsTrue(graph.TriplesCount == 1);
            Assert.IsTrue(graph.IndexedTriples.Any(t => t.Value.SubjectID.Equals(new RDFResource("ex:NodeShape").PatternMemberID)
                                                    && t.Value.PredicateID.Equals(RDFVocabulary.SHACL.MIN_EXCLUSIVE.PatternMemberID)
                                                        && t.Value.ObjectID.Equals(new RDFResource("ex:value").PatternMemberID)));
        }

        [TestMethod]
        public void ShouldCreateMinExclusiveLiteralConstraint()
        {
            RDFMinExclusiveConstraint minExclusiveConstraint = new RDFMinExclusiveConstraint(new RDFPlainLiteral("value"));

            Assert.IsNotNull(minExclusiveConstraint);
            Assert.IsTrue(minExclusiveConstraint.Value.Equals(new RDFPlainLiteral("value")));
        }

        [TestMethod]
        public void ShouldThrowExceptionOnCreatingMinExclusiveLiteralConstraint()
            => Assert.ThrowsException<RDFModelException>(() => new RDFMinExclusiveConstraint(null as RDFLiteral));
        ...
        public void ShouldConformNodeShapeWithClassTarget()
        {
            ...
            nodeShape.AddConstraint(new RDFMinExclusiveConstraint(new RDFResource("ex:Alibe")));
        ...
        public void ShouldConformPropertyShapeWithClassTarget()
        {
            ...
            propertyShape.AddConstraint(new RDFMinExclusiveConstraint(new RDFResource("ex:Alibe")));
        ...
        public void ShouldNotConformNodeShapeWithClassTarget()
        {
            ...
            RDFNodeShape nodeShape = new RDFNodeShape(new RDFResource("ex:NodeShape"));
            nodeShape.AddTarget(new RDFTargetClass(new RDFResource("ex:Person")));
            nodeShape.AddConstraint(new RDFMinExclusiveConstraint(new RDFResource("ex:Barry")));
            shapesGraph.AddShape(nodeShape);
            ...
            Assert.IsTrue(validationReport.Results[0].ResultMessages[0].Equals(new RDFPlainLiteral("Must have values greater than <ex:Barry>")));
            ...
            Assert.IsTrue(validationReport.Results[0].SourceConstraintComponent.Equals(RDFVocabulary.SHACL.MIN_EXCLUSIVE_CONSTRAINT_COMPONENT));
        ...
        public void ShouldNotConformPropertyShapeWithClassTarget()
        {
            ...
            RDFPropertyShape propertyShape = new RDFPropertyShape(new RDFResource("ex:PropertyShape"), RDFVocabulary.FOAF.KNOWS);
            propertyShape.AddTarget(new RDFTargetClass(new RDFResource("ex:Person")));
            propertyShape.AddConstraint(new RDFMinExclusiveConstraint(new RDFResource("ex:Barry")));
            shapesGraph.AddShape(propertyShape);
        ...
        public void ShouldConformNodeShapeWithPropertyShape()
        {
            ...
            propShape.AddConstraint(new RDFMinExclusiveConstraint(new RDFTypedLiteral("1998-01-01", RDFModelEnums.RDFDatatypes.XSD_DATE)));
        ...
        public void ShouldNotConformNodeShapeWithPropertyShape()
        {
            ...
            nodeShape.AddTarget(new RDFTargetNode(new RDFResource("ex:Bob")));
            RDFPropertyShape propShape = new RDFPropertyShape(new RDFResource("ex:PropShape"), new RDFResource("ex:birthDate"));
            propShape.AddConstraint(new RDFMinExclusiveConstraint(new RDFTypedLiteral("1999-01-01", RDFModelEnums.RDFDatatypes.XSD_DATE)));
            nodeShape.AddConstraint(new RDFPropertyConstraint(propShape));
            shapesGraph.AddShape(nodeShape);
            shapesGraph.AddShape(propShape);
            ...
            Assert.IsTrue(validationReport.Results[0].Severity == RDFValidationEnums.RDFShapeSeverity.Violation);
            Assert.IsTrue(validationReport.Results[0].ResultMessages.Count == 1);
            Assert.IsTrue(validationReport.Results[0].ResultMessages[0].Equals(new RDFPlainLiteral("Must have values greater than <1999-01-01Z^^http://www.w3.org/2001/XMLSchema#date>")));
            Assert.IsTrue(validationReport.Results[0].FocusNode.Equals(new RDFResource("ex:Bob")));
