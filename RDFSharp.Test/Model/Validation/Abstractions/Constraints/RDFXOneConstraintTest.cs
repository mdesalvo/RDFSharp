...
public class RDFXoneConstraintTest
{
    ...
    public void ShouldCreateXoneConstraint()
    {
        ...
        Assert.IsEmpty(xoneConstraint.XoneShapes);
    }
    ...
    public void ShouldAddShape()
    {
        ...
        Assert.IsNotNull(xoneConstraint);
        Assert.IsNotNull(xoneConstraint.XoneShapes);
        Assert.HasCount(2, xoneConstraint.XoneShapes);
    }
    ...
    public void ShouldExportXoneConstraint()
    {
        ...
        Assert.IsTrue(graph.Index.Hashes.Any(t => t.Value.SubjectID.Equals(new RDFResource("ex:NodeShape").PatternMemberID)
                                                    && t.Value.PredicateID.Equals(RDFVocabulary.SHACL.XONE.PatternMemberID)));
