...
[TestClass]
public class RDFOrConstraintTest
{
    #region Tests
    [TestMethod]
    public void ShouldCreateOrConstraint()
    {
        RDFOrConstraint orConstraint = new RDFOrConstraint();

        Assert.IsNotNull(orConstraint);
        Assert.IsNotNull(orConstraint.OrShapes);
        Assert.IsEmpty(orConstraint.OrShapes);
    }
    ...
    {
        RDFOrConstraint orConstraint = new RDFOrConstraint();
        orConstraint.AddShape(new RDFNodeShape(new RDFResource("ex:NodeShape1")));
        orConstraint.AddShape(new RDFNodeShape(new RDFResource("ex:NodeShape2")));
        orConstraint.AddShape(new RDFNodeShape(new RDFResource("ex:NodeShape1"))); //Will be discarded
        orConstraint.AddShape(null); //Will be discarded

        Assert.IsNotNull(orConstraint);
        Assert.IsNotNull(orConstraint.OrShapes);
        Assert.HasCount(2, orConstraint.OrShapes);
    }

    [TestMethod]
    public void ShouldExportOrConstraint()
    {
        RDFOrConstraint orConstraint = new RDFOrConstraint();
        orConstraint.AddShape(new RDFNodeShape(new RDFResource("ex:NodeShape1")));
        orConstraint.AddShape(new RDFNodeShape(new RDFResource("ex:NodeShape2")));
        RDFGraph graph = orConstraint.ToRDFGraph(new RDFNodeShape(new RDFResource("ex:NodeShape")));
        ...
        Assert.IsTrue(graph.Index.Hashes.Any(t => t.Value.SubjectID.Equals(new RDFResource("ex:NodeShape").PatternMemberID)
                                                    && t.Value.PredicateID.Equals(RDFVocabulary.SHACL.OR.PatternMemberID)));
        Assert.IsTrue(graph.Index.Hashes.Any(t => t.Value.PredicateID.Equals(RDFVocabulary.RDF.TYPE.PatternMemberID)
                                                    && t.Value.ObjectID.Equals(RDFVocabulary.RDF.LIST.PatternMemberID))); //2 occurrences of this
        Assert.IsTrue(graph.Index.Hashes.Any(t => t.Value.PredicateID.Equals(RDFVocabulary.RDF.FIRST.PatternMemberID)
                                                    && t.Value.ObjectID.Equals(new RDFResource("ex:NodeShape1").PatternMemberID)));
        Assert.IsTrue(graph.Index.Hashes.Any(t => t.Value.PredicateID.Equals(RDFVocabulary.RDF.REST.PatternMemberID)));
        Assert.IsTrue(graph.Index.Hashes.Any(t => t.Value.PredicateID.Equals(RDFVocabulary.RDF.FIRST.PatternMemberID)
                                                    && t.Value.ObjectID.Equals(new RDFResource("ex:NodeShape2").PatternMemberID)));
        Assert.IsTrue(graph.Index.Hashes.Any(t => t.Value.PredicateID.Equals(RDFVocabulary.RDF.REST.PatternMemberID)
    ...
    public void ShouldConformNodeShapeWithClassTarget()
    {
        ...
        nodeShape.AddConstraint(new RDFOrConstraint().AddShape(new RDFResource("ex:NodeShape1"))
    ...
    public void ShouldNotConformNodeShapeWithClassTarget()
    {
        ...
        RDFShapesGraph shapesGraph = new RDFShapesGraph(new RDFResource("ex:ShapesGraph"));
        RDFNodeShape nodeShape1 = new RDFNodeShape(new RDFResource("ex:NodeShape1"));
        nodeShape1.AddConstraint(new RDFMinLengthConstraint(9));
        RDFNodeShape nodeShape2 = new RDFNodeShape(new RDFResource("ex:NodeShape2"));
    ...
    public void ShouldNotConformNodeShapeWithPropertyShapes1()
    {
        ...
        nodeShape2.AddConstraint(new RDFOrConstraint().AddShape(nodeShape1)
            .AddShape(propShape2));
        shapesGraph.AddShape(nodeShape1);
        shapesGraph.AddShape(nodeShape2);
        shapesGraph.AddShape(propShape1);
