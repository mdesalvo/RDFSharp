...
[TestClass]
public class RDFMaxInclusiveConstraintTest
{
    #region Tests
    [TestMethod]
    public void ShouldCreateMaxInclusiveResourceConstraint()
    {
        RDFMaxInclusiveConstraint maxInclusiveConstraint = new RDFMaxInclusiveConstraint(new RDFResource("ex:value"));

        Assert.IsNotNull(maxInclusiveConstraint);
        Assert.IsTrue(maxInclusiveConstraint.Value.Equals(new RDFResource("ex:value")));
    }

    [TestMethod]
    public void ShouldThrowExceptionOnCreatingMaxInclusiveResourceConstraint()
        => Assert.ThrowsException<RDFModelException>(() => new RDFMaxInclusiveConstraint(null as RDFResource));

    [TestMethod]
    public void ShouldExportMaxInclusiveResourceConstraint()
    {
        RDFMaxInclusiveConstraint maxInclusiveConstraint = new RDFMaxInclusiveConstraint(new RDFResource("ex:value"));
        RDFGraph graph = maxInclusiveConstraint.ToRDFGraph(new RDFNodeShape(new RDFResource("ex:NodeShape")));
        ...
        Assert.IsTrue(graph.IndexedTriples.Any(t => t.Value.SubjectID.Equals(new RDFResource("ex:NodeShape").PatternMemberID)
                                                    && t.Value.PredicateID.Equals(RDFVocabulary.SHACL.MAX_INCLUSIVE.PatternMemberID)
                                                    && t.Value.ObjectID.Equals(new RDFResource("ex:value").PatternMemberID)));
    }

    [TestMethod]
    public void ShouldCreateMaxInclusiveLiteralConstraint()
    {
        RDFMaxInclusiveConstraint maxInclusiveConstraint = new RDFMaxInclusiveConstraint(new RDFPlainLiteral("value"));

        Assert.IsNotNull(maxInclusiveConstraint);
        Assert.IsTrue(maxInclusiveConstraint.Value.Equals(new RDFPlainLiteral("value")));
    }

    [TestMethod]
    public void ShouldThrowExceptionOnCreatingMaxInclusiveLiteralConstraint()
        => Assert.ThrowsException<RDFModelException>(() => new RDFMaxInclusiveConstraint(null as RDFLiteral));
    ...
    public void ShouldConformNodeShapeWithClassTarget()
    {
        ...
        nodeShape.AddConstraint(new RDFMaxInclusiveConstraint(new RDFResource("ex:Steve")));
    ...
    public void ShouldConformNodeShapeWithNodeTarget()
    {
        ...
        nodeShape.AddConstraint(new RDFMaxInclusiveConstraint(new RDFResource("ex:Alice")));
        shapesGraph.AddShape(nodeShape);
    ...
    public void ShouldConformNodeShapeWithSubjectsOfTarget()
    {
        ...
        nodeShape.AddConstraint(new RDFMaxInclusiveConstraint(new RDFResource("ex:Bob")));
        shapesGraph.AddShape(nodeShape);
    ...
    public void ShouldConformPropertyShapeWithClassTarget()
    {
        ...
        propertyShape.AddConstraint(new RDFMaxInclusiveConstraint(new RDFResource("ex:Bob")));
    ...
    public void ShouldNotConformNodeShapeWithClassTarget()
    {
        ...
        RDFNodeShape nodeShape = new RDFNodeShape(new RDFResource("ex:NodeShape"));
        nodeShape.AddTarget(new RDFTargetClass(new RDFResource("ex:Person")));
        nodeShape.AddConstraint(new RDFMaxInclusiveConstraint(new RDFResource("ex:Steva")));
        shapesGraph.AddShape(nodeShape);
        ...
        Assert.IsTrue(validationReport.Results[0].ResultMessages[0].Equals(new RDFPlainLiteral("Must have values lower or equal than <ex:Steva>")));
    ...
    public void ShouldNotConformNodeShapeWithSubjectsOfTarget()
    {
        ...
        RDFNodeShape nodeShape = new RDFNodeShape(new RDFResource("ex:NodeShape"));
        nodeShape.AddTarget(new RDFTargetSubjectsOf(RDFVocabulary.FOAF.KNOWS));
        nodeShape.AddConstraint(new RDFMaxInclusiveConstraint(new RDFResource("ex:Boa")));
        shapesGraph.AddShape(nodeShape);
        ...
        Assert.AreEqual(RDFValidationEnums.RDFShapeSeverity.Violation, validationReport.Results[0].Severity);
        Assert.AreEqual(1, validationReport.Results[0].ResultMessages.Count);
        Assert.IsTrue(validationReport.Results[0].ResultMessages[0].Equals(new RDFPlainLiteral("Must have values lower or equal than <ex:Boa>")));
    ...
    public void ShouldNotConformPropertyShapeWithClassTarget()
    {
        ...
        RDFPropertyShape propertyShape = new RDFPropertyShape(new RDFResource("ex:PropertyShape"), RDFVocabulary.FOAF.KNOWS);
        propertyShape.AddTarget(new RDFTargetClass(new RDFResource("ex:Person")));
        propertyShape.AddConstraint(new RDFMaxInclusiveConstraint(new RDFResource("ex:Boa")));
        shapesGraph.AddShape(propertyShape);
    ...
    public void ShouldConformNodeShapeWithPropertyShape()
    {
        ...
        propShape.AddConstraint(new RDFMaxInclusiveConstraint(new RDFTypedLiteral("1999-12-24", RDFModelEnums.RDFDatatypes.XSD_DATE)));
    ...
    public void ShouldNotConformNodeShapeWithPropertyShape()
    {
        ...
        nodeShape.AddTarget(new RDFTargetNode(new RDFResource("ex:Bob")));
        RDFPropertyShape propShape = new RDFPropertyShape(new RDFResource("ex:PropShape"), new RDFResource("ex:birthDate"));
        propShape.AddConstraint(new RDFMaxInclusiveConstraint(new RDFTypedLiteral("1999-12-30", RDFModelEnums.RDFDatatypes.XSD_DATE)));
        nodeShape.AddConstraint(new RDFPropertyConstraint(propShape));
        shapesGraph.AddShape(nodeShape);
        shapesGraph.AddShape(propShape);
        ...
        Assert.AreEqual(RDFValidationEnums.RDFShapeSeverity.Violation, validationReport.Results[0].Severity);
        Assert.AreEqual(1, validationReport.Results[0].ResultMessages.Count);
        Assert.IsTrue(validationReport.Results[0].ResultMessages[0].Equals(new RDFPlainLiteral("Must have values lower or equal than <1999-12-30Z^^http://www.w3.org/2001/XMLSchema#date>")));
        Assert.IsTrue(validationReport.Results[0].FocusNode.Equals(new RDFResource("ex:Alice")));
