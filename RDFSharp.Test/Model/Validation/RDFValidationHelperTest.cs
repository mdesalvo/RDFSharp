...
public class RDFValidationHelperTest
{
    ...
    public void ShouldParseNodeShapeFromGraph(RDFValidationEnums.RDFShapeSeverity severity, RDFValidationEnums.RDFNodeKinds nodeKind)
    {
        ...
        RDFHasValueConstraint shape2HasValueConstraintRes = shape2.Constraints.Single(x => x is RDFHasValueConstraint
        {
            Value: RDFResource
        ...
        RDFHasValueConstraint shape2HasValueConstraintLit = shape2.Constraints.Single(x => x is RDFHasValueConstraint
        {
            Value: RDFLiteral
        }) as RDFHasValueConstraint;
        ...
        RDFInConstraint shape2InConstraintRes = shape2.Constraints.Single(x => x is RDFInConstraint { ItemType: RDFModelEnums.RDFItemTypes.Resource }) as RDFInConstraint;
        ...
        RDFInConstraint shape2InConstraintLit = shape2.Constraints.Single(x => x is RDFInConstraint { ItemType: RDFModelEnums.RDFItemTypes.Literal }) as RDFInConstraint;
