...
public class RDFXmlTest
{
    ...
    public void ShouldSerializeGraphWithSPBTripleHavingMixedCollectionAsObject()
    {
        ...
        Assert.IsTrue(adjustedFileContent.Equals($"{XmlHeader}{Environment.NewLine}<rdf:RDF {XmlNsRDF} xmlns:autoNS1=\"http://pred/\" {XmlBaseDefault}>{Environment.NewLine}{" ",2}<rdf:Description rdf:about=\"http://subj/\">{Environment.NewLine}{" ",4}<autoNS1:pred rdf:resource=\"http://coll/\" />{Environment.NewLine}{" ",2}</rdf:Description>{Environment.NewLine}{" ",2}<rdf:Description rdf:about=\"http://coll/\">{Environment.NewLine}{" ",4}<rdf:type rdf:resource=\"http://www.w3.org/1999/02/22-rdf-syntax-ns#List\" />{Environment.NewLine}{" ",4}<rdf:first rdf:resource=\"urn:swrl:var#V\" />{Environment.NewLine}{" ",4}<rdf:rest rdf:nodeID=\"12345\" />{Environment.NewLine}{" ",2}</rdf:Description>{Environment.NewLine}{" ",2}<rdf:Description rdf:nodeID=\"12345\">{Environment.NewLine}{" ",4}<rdf:type rdf:resource=\"http://www.w3.org/1999/02/22-rdf-syntax-ns#List\" />{Environment.NewLine}{" ",4}<rdf:first>item1</rdf:first>{Environment.NewLine}{" ",4}<rdf:rest rdf:parseType=\"Collection\">{Environment.NewLine}{" ",6}<rdf:Description rdf:about=\"http://item2/\" />{Environment.NewLine}{" ",4}</rdf:rest>{Environment.NewLine}{" ",2}</rdf:Description>{Environment.NewLine}</rdf:RDF>"));      
    }
    ...
    public void ShouldDeserializeGraphWithSPLTripleHavingDTDEntityAsLiteral()
    {
        ...
        Assert.IsNotNull(graph);
        Assert.IsTrue(graph.Context.Equals(RDFNamespaceRegister.DefaultNamespace.NamespaceUri));
        Assert.IsTrue(graph.ContainsTriple(new RDFTriple(new RDFResource("http://subj/"), new RDFResource("http://pred/pred"), new RDFPlainLiteral("test")))); //DTD entity will be resolved
    }

    [TestMethod]
    public void ShouldDeserializeGraphWithSPLTripleHavingXXEEntityAsLiteralNotExploited()
    {
        string filePath = Path.Combine(Environment.CurrentDirectory, "rdfxmlxxe.txt");
    ...
    [TestMethod]
    public void ShouldDeserializeGraphWithSPOTripleHavingDTDEntityAsObject()
    {
        MemoryStream stream = new MemoryStream();
        using (StreamWriter writer = new StreamWriter(stream))
        ...
        Assert.IsNotNull(graph);
        Assert.IsTrue(graph.Context.Equals(RDFNamespaceRegister.DefaultNamespace.NamespaceUri));
        Assert.IsTrue(graph.ContainsTriple(new RDFTriple(new RDFResource("http://subj/"), new RDFResource("http://pred/pred"), new RDFResource("http://ex.org/"))));
    }
    ...
    public void ShouldDeserializeGraphWithBPOAnonymousTriple()
    {
        ...
        Assert.IsNotNull(graph);
        Assert.IsTrue(graph.Context.Equals(RDFNamespaceRegister.DefaultNamespace.NamespaceUri));
        Assert.IsTrue(graph.Any(t => t.Subject is RDFResource { IsBlank: true } && t.Predicate.Equals(new RDFResource("http://pred/pred")) && t.Object.Equals(new RDFResource("http://obj/"))));
    }
    ...
    public void ShouldDeserializeGraphWithBPBAnonymousNestedTriples()
    {
        ...
        Assert.IsNotNull(graph);
        Assert.IsTrue(graph.Context.Equals(RDFNamespaceRegister.DefaultNamespace.NamespaceUri));
        Assert.IsTrue(graph.Any(t => t.Subject is RDFResource { IsBlank: true } && t.Predicate.Equals(new RDFResource("http://pred/pred")) && t.Object is RDFResource
        {
            IsBlank: true
        }));
        Assert.IsTrue(graph.Any(t => t.Subject is RDFResource { IsBlank: true } && t.Predicate.Equals(new RDFResource("http://pred/pred2")) && t.Object is RDFResource
        {
            IsBlank: true
        }));
    }
    ...
    public void ShouldDeserializeGraphWithBPBAnonymousNestedTriplesHavingAltContainer()
    {
        ...
        Assert.IsTrue(graph.Any(t => t.Subject is RDFResource { IsBlank: true } && t.Predicate.Equals(RDFVocabulary.RDF.TYPE) && t.Object.Equals(RDFVocabulary.RDF.ALT)));
        Assert.IsTrue(graph.Any(t => t.Subject is RDFResource { IsBlank: true } && t.Predicate.Equals(new RDFResource(RDFVocabulary.RDF.BASE_URI + "_1")) && t.Object.Equals(new RDFResource("http://item1/"))));
    }
    ...
    public void ShouldDeserializeGraphWithBPBAnonymousNestedTriplesHavingAltContainerOfBlankResources()
    {
        ...
        Assert.IsTrue(graph.Any(t => t.Subject is RDFResource { IsBlank: true } && t.Predicate.Equals(RDFVocabulary.RDF.TYPE) && t.Object.Equals(RDFVocabulary.RDF.ALT)));
        Assert.IsTrue(graph.Any(t => t.Subject is RDFResource { IsBlank: true } && t.Predicate.Equals(new RDFResource(RDFVocabulary.RDF.BASE_URI + "_1")) && t.Object.Equals(new RDFResource("bnode:12345"))));
    }
    ...
    public void ShouldDeserializeGraphWithBPBAnonymousNestedTriplesHavingBagContainer()
    {
        ...
        Assert.IsTrue(graph.Any(t => t.Subject is RDFResource { IsBlank: true } && t.Predicate.Equals(RDFVocabulary.RDF.TYPE) && t.Object.Equals(RDFVocabulary.RDF.BAG)));
        Assert.IsTrue(graph.Any(t => t.Subject is RDFResource { IsBlank: true } && t.Predicate.Equals(new RDFResource(RDFVocabulary.RDF.BASE_URI + "_1")) && t.Object.Equals(new RDFResource("http://item1/"))));
    }
    ...
    public void ShouldDeserializeGraphWithBPBAnonymousNestedTriplesHavingSeqContainer()
    {
        ...
        Assert.IsTrue(graph.Any(t => t.Subject is RDFResource { IsBlank: true } && t.Predicate.Equals(RDFVocabulary.RDF.TYPE) && t.Object.Equals(RDFVocabulary.RDF.SEQ)));
        Assert.IsTrue(graph.Any(t => t.Subject is RDFResource { IsBlank: true } && t.Predicate.Equals(new RDFResource(RDFVocabulary.RDF.BASE_URI + "_1")) && t.Object.Equals(new RDFResource("http://item1/"))));
    }
    ...
    public void ShouldDeserializeGraphWithBPBAnonymousNestedTriplesHavingAltContainerOfLiterals()
    {
        ...
        Assert.IsTrue(graph.Any(t => t.Subject is RDFResource { IsBlank: true } && t.Predicate.Equals(RDFVocabulary.RDF.TYPE) && t.Object.Equals(RDFVocabulary.RDF.ALT)));
        Assert.IsTrue(graph.Any(t => t.Subject is RDFResource { IsBlank: true } && t.Predicate.Equals(new RDFResource(RDFVocabulary.RDF.BASE_URI + "_1")) && t.Object.Equals(new RDFPlainLiteral("item1"))));
        Assert.IsTrue(graph.Any(t => t.Subject is RDFResource { IsBlank: true } && t.Predicate.Equals(new RDFResource(RDFVocabulary.RDF.BASE_URI + "_2")) && t.Object.Equals(new RDFPlainLiteral("item2"))));
    }
    ...
    public void ShouldDeserializeGraphWithBPBAnonymousNestedTriplesHavingAltContainerOfLiteralsWithSubjectScopedLanguage()
    {
        ...
        Assert.IsTrue(graph.Any(t => t.Subject is RDFResource { IsBlank: true } && t.Predicate.Equals(RDFVocabulary.RDF.TYPE) && t.Object.Equals(RDFVocabulary.RDF.ALT)));
        Assert.IsTrue(graph.Any(t => t.Subject is RDFResource { IsBlank: true } && t.Predicate.Equals(new RDFResource(RDFVocabulary.RDF.BASE_URI + "_1")) && t.Object.Equals(new RDFPlainLiteral("item1", "en-US"))));
        Assert.IsTrue(graph.Any(t => t.Subject is RDFResource { IsBlank: true } && t.Predicate.Equals(new RDFResource(RDFVocabulary.RDF.BASE_URI + "_2")) && t.Object.Equals(new RDFPlainLiteral("item2", "en-US"))));
    }
    ...
    public void ShouldDeserializeGraphWithBPBAnonymousNestedTriplesHavingAltContainerOfLiteralsWithDatatype()
    {
        ...
        Assert.IsTrue(graph.Any(t => t.Subject is RDFResource { IsBlank: true } && t.Predicate.Equals(RDFVocabulary.RDF.TYPE) && t.Object.Equals(RDFVocabulary.RDF.ALT)));
        Assert.IsTrue(graph.Any(t => t.Subject is RDFResource { IsBlank: true } && t.Predicate.Equals(new RDFResource(RDFVocabulary.RDF.BASE_URI + "_1")) && t.Object.Equals(new RDFTypedLiteral("item1", RDFModelEnums.RDFDatatypes.XSD_STRING))));
        Assert.IsTrue(graph.Any(t => t.Subject is RDFResource { IsBlank: true } && t.Predicate.Equals(new RDFResource(RDFVocabulary.RDF.BASE_URI + "_2")) && t.Object.Equals(new RDFTypedLiteral("item2", RDFModelEnums.RDFDatatypes.XSD_STRING))));
    }
    ...
    public void ShouldDeserializeGraphWithBPBTripleUsingParseTypeResourceAttribute()
    {
        ...
        Assert.IsNotNull(graph);
        Assert.IsTrue(graph.Context.Equals(RDFNamespaceRegister.DefaultNamespace.NamespaceUri));
        Assert.IsTrue(graph.Any(t => t.Subject.Equals(new RDFResource("bnode:12345")) && t.Predicate.Equals(new RDFResource("http://pred/pred")) && t.Object is RDFResource
        {
            IsBlank: true
        }));
        Assert.IsTrue(graph.Any(t => t.Subject is RDFResource { IsBlank: true } && t.Predicate.Equals(new RDFResource("http://pred/pred2")) && t.Object is RDFResource
    ...
    public void ShouldDeserializeGraphWithBPBAnonymousNestedTriplesHavingCollection()
    {
        ...
        Assert.IsTrue(graph.Any(t => t.Subject is RDFResource { IsBlank: true } && t.Predicate.Equals(RDFVocabulary.RDF.FIRST) && t.Object.Equals(new RDFResource("http://item2/"))));
        Assert.IsTrue(graph.Any(t => t.Subject is RDFResource { IsBlank: true } && t.Predicate.Equals(RDFVocabulary.RDF.REST) && t.Object.Equals(RDFVocabulary.RDF.NIL)));
    }
