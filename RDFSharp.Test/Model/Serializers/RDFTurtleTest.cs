...
public class RDFTurtleTest
{
    ...
    public void ShouldDeserializeGraphWithCustomDatatypeSPLTTriple()
    {
        MemoryStream stream = new MemoryStream();
        using (StreamWriter writer = new StreamWriter(stream))
            writer.WriteLine($"@base <{RDFNamespaceRegister.DefaultNamespace}>.{Environment.NewLine}<http://subj/> <http://pred/> \"hello\"^^xsd:testdt.");
        RDFGraph graph = RDFTurtle.Deserialize(new MemoryStream(stream.ToArray()), null);
    ...
    public void ShouldDeserializeGraphWithSPBAnonymousTriplesHavingSameSubject()
    {
        ...
        Assert.IsTrue(graph.Any(t => t.Subject.Equals(new RDFResource("http://subj/")) && t.Predicate.Equals(new RDFResource("http://pred2/")) && t.Object is RDFResource
        {
            IsBlank: true
        }));
    }
    ...
    public void ShouldDeserializeGraphWithSPBAnonymousTriplesHavingSameSubjectAndUsingRegisteredNamespaceInSubject()
    {
        ...
        Assert.IsTrue(graph.Any(t => t.Subject.Equals(RDFVocabulary.RDF.ALT) && t.Predicate.Equals(new RDFResource("http://pred2/")) && t.Object is RDFResource
        {
            IsBlank: true
        }));
    }
    ...
    public void ShouldDeserializeGraphWithSPBAnonymousTriplesHavingSameSubjectAndUsingRegisteredNamespaceInPredicate()
    {
        ...
        Assert.IsTrue(graph.Any(t => t.Subject.Equals(new RDFResource("http://subj/")) && t.Predicate.Equals(RDFVocabulary.RDF.BAG) && t.Object is RDFResource
        {
            IsBlank: true
        }));
    }
    ...
    public void ShouldDeserializeGraphWithBPBAnonymousTriplesHavingSameSubject()
    {
        ...
        Assert.IsTrue(graph.Any(t => t.Subject is RDFResource { IsBlank: true } && t.Predicate.Equals(new RDFResource("http://pred2/")) && t.Object is RDFResource
        {
            IsBlank: true
        }));
    }
    ...
    public void ShouldDeserializeGraphWithBPBAnonymousTriplesHavingSameSubjectAndUsingRegisteredNamespaceInPredicate()
    {
        ...
        Assert.IsTrue(graph.Any(t => t.Subject is RDFResource { IsBlank: true } && t.Predicate.Equals(RDFVocabulary.RDF.BAG) && t.Object is RDFResource
        {
            IsBlank: true
        }));
    }
