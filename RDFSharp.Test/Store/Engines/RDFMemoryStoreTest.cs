...
public class RDFMemoryStoreTest
{
    ...
    public void ShouldCreateMemoryStore()
    {
        ...
        Assert.AreEqual(6, store.Quadruples.Columns.Count);
        Assert.IsTrue(store.Quadruples.Columns.Contains("QID"));
        Assert.IsTrue(store.Quadruples.Columns.Contains("CID"));
        Assert.IsTrue(store.Quadruples.Columns.Contains("SID"));
        Assert.IsTrue(store.Quadruples.Columns.Contains("PID"));
        Assert.IsTrue(store.Quadruples.Columns.Contains("OID"));
        Assert.IsTrue(store.Quadruples.Columns.Contains("TFV"));
        Assert.IsNotNull(store.Quadruples.PrimaryKey);
        Assert.AreEqual("QID", store.Quadruples.PrimaryKey[0].ColumnName);
        Assert.IsNotNull(store.Quadruples.ExtendedProperties["CTX"]);
        Assert.IsNotNull(store.Quadruples.ExtendedProperties["RES"]);
        Assert.IsNotNull(store.Quadruples.ExtendedProperties["LIT"]);
        Assert.IsEmpty((Dictionary<long, RDFContext>)store.Quadruples.ExtendedProperties["CTX"]!);
        Assert.IsEmpty((Dictionary<long, RDFResource>)store.Quadruples.ExtendedProperties["RES"]!);
        Assert.IsEmpty((Dictionary<long, RDFLiteral>)store.Quadruples.ExtendedProperties["LIT"]!);
    ...
    public void ShouldCreateMemoryStoreWithQuadruples()
    {
        ...
        Assert.HasCount(1, (Dictionary<long, RDFContext>)store.Quadruples.ExtendedProperties["CTX"]!);
        Assert.IsTrue(((Dictionary<long, RDFContext>)store.Quadruples.ExtendedProperties["CTX"]!).ContainsKey(new RDFContext("ex:c").PatternMemberID));
        Assert.HasCount(3, (Dictionary<long, RDFResource>)store.Quadruples.ExtendedProperties["RES"]!);
        Assert.IsTrue(((Dictionary<long, RDFResource>)store.Quadruples.ExtendedProperties["RES"]!).ContainsKey(new RDFResource("ex:s").PatternMemberID));
        Assert.IsTrue(((Dictionary<long, RDFResource>)store.Quadruples.ExtendedProperties["RES"]!).ContainsKey(new RDFResource("ex:p").PatternMemberID));
        Assert.IsTrue(((Dictionary<long, RDFResource>)store.Quadruples.ExtendedProperties["RES"]!).ContainsKey(new RDFResource("ex:o").PatternMemberID));
        Assert.HasCount(1, (Dictionary<long, RDFLiteral>)store.Quadruples.ExtendedProperties["LIT"]!);
        Assert.IsTrue(((Dictionary<long, RDFLiteral>)store.Quadruples.ExtendedProperties["LIT"]!).ContainsKey(new RDFPlainLiteral("lit").PatternMemberID));
    ...
    public void ShouldDisposeMemoryStoreWithUsing()
    {
        ...
        Assert.IsNull(store.Quadruples);
    }
    ...
    public void ShouldSelectQuadruplesByContext()
    {
        ...
        List<RDFQuadruple> result = data.SelectQuadruples(c: ctx1);
    ...
    public void ShouldSelectQuadruplesBySubject()
    {
        ...
        List<RDFQuadruple> result = data.SelectQuadruples(s: subj1);
    ...
    public void ShouldSelectQuadruplesByPredicate()
    {
        ...
        List<RDFQuadruple> result = data.SelectQuadruples(p: pred1);
    ...
    public void ShouldSelectQuadruplesByObject()
    {
        ...
        List<RDFQuadruple> result = data.SelectQuadruples(o: obj1);
    ...
    public void ShouldSelectQuadruplesByLiteral()
    {
        ...
        List<RDFQuadruple> result = data.SelectQuadruples(l: lit2);
    ...
    public void ShouldSelectQuadruplesByContextSubject()
    {
        ...
        List<RDFQuadruple> result = data.SelectQuadruples(c: ctx1, s: subj1);
    ...
    public void ShouldSelectQuadruplesByContextPredicate()
    {
        ...
        List<RDFQuadruple> result = data.SelectQuadruples(c: ctx1, p: pred1);
    ...
    public void ShouldSelectQuadruplesByContextObject()
    {
        ...
        List<RDFQuadruple> result = data.SelectQuadruples(c: ctx1, o: obj1);
    ...
    public void ShouldSelectQuadruplesByContextLiteral()
    {
        ...
        List<RDFQuadruple> result = data.SelectQuadruples(c: ctx1, l: lit);
    ...
    public void ShouldSelectQuadruplesByContextSubjectPredicate()
    {
        ...
        List<RDFQuadruple> result = data.SelectQuadruples(c: ctx1, s: subj1, p: pred1);
    ...
    public void ShouldSelectQuadruplesByContextSubjectObject()
    {
        ...
        List<RDFQuadruple> result = data.SelectQuadruples(c: ctx1, s: subj1,o: obj1);
    ...
    public void ShouldSelectQuadruplesByContextSubjectLiteral()
    {
        ...
        List<RDFQuadruple> result = data.SelectQuadruples(c: ctx1, s: subj2, l: lit);
    ...
    public void ShouldSelectQuadruplesByContextPredicateObject()
    {
        ...
        List<RDFQuadruple> result = data.SelectQuadruples(c: ctx1, p: pred1, o: obj1);
    ...
    public void ShouldSelectQuadruplesByContextPredicateLiteral()
    {
        ...
        List<RDFQuadruple> result = data.SelectQuadruples(c: ctx1, p: pred1, l: lit);
    ...
    public void ShouldSelectQuadruplesByContextSubjectPredicateObject()
    {
        ...
        List<RDFQuadruple> result = data.SelectQuadruples(c: ctx1, s: subj1, p: pred1, o: obj1);
    ...
    public void ShouldSelectQuadruplesByContextSubjectPredicateLiteral()
    {
        ...
        List<RDFQuadruple> result = data.SelectQuadruples(c: ctx1, s: subj2, p: pred1, l: lit);
    ...
    public void ShouldSelectQuadruplesBySubjectPredicate()
    {
        ...
        List<RDFQuadruple> result = data.SelectQuadruples(s: subj1, p: pred1);
    ...
    public void ShouldSelectQuadruplesBySubjectObject()
    {
        ...
        List<RDFQuadruple> result = data.SelectQuadruples(s: subj1, o: obj1);
    ...
    public void ShouldSelectQuadruplesBySubjectLiteral()
    {
        ...
        List<RDFQuadruple> result = data.SelectQuadruples(s: subj2, l: lit);
    ...
    public void ShouldSelectQuadruplesByPredicateObject()
    {
        ...
        List<RDFQuadruple> result = data.SelectQuadruples(p: pred1, o: obj1);
    ...
    public void ShouldSelectQuadruplesByPredicateLiteral()
    {
        ...
        List<RDFQuadruple> result = data.SelectQuadruples(p: pred1, l: lit);
    ...
    public void ShouldSelectQuadruplesBySubjectPredicateObject()
    {
        ...
        List<RDFQuadruple> result = data.SelectQuadruples(s: subj1, p: pred1, o: obj1);
    ...
    public void ShouldSelectQuadruplesBySubjectPredicateLiteral()
    {
        ...
        List<RDFQuadruple> result = data.SelectQuadruples(s: subj2, p: pred1, l: lit);
    ...
    public void ShouldNotSelectQuadruplesByContext()
    {
        ...
        List<RDFQuadruple> result = data.SelectQuadruples(c: ctx2);
    ...
    public void ShouldNotSelectQuadruplesBySubject()
    {
        ...
        List<RDFQuadruple> result = data.SelectQuadruples(s: subj2);
    ...
    public void ShouldNotSelectQuadruplesByPredicate()
    {
        ...
        List<RDFQuadruple> result = data.SelectQuadruples(p: pred2);
    ...
    public void ShouldNotSelectQuadruplesByObject()
    {
        ...
        List<RDFQuadruple> result = data.SelectQuadruples(o: obj2);
    ...
    public void ShouldNotSelectQuadruplesAtMiddle()
    {
        ...
        List<RDFQuadruple> result = data.SelectQuadruples(c: ctx1, s: subj1, p: pred2, l: lit);
    ...
    public void ShouldNotSelectQuadruplesAtLast()
    {
        ...
        List<RDFQuadruple> result = data.SelectQuadruples(c: ctx1, s: subj1, p: pred1, l: lit2);
    ...
    public void ShouldSelectQuadruplesByContextAccessor()
    {
        ...
        store.AddQuadruple(new RDFQuadruple(new RDFContext("ex:ctx1"), new RDFResource("ex:subj"), new RDFResource("ex:pred"), new RDFPlainLiteral("lit")));
        store.AddQuadruple(new RDFQuadruple(new RDFContext("ex:ctx2"), new RDFResource("ex:subj"), new RDFResource("ex:pred"), new RDFResource("ex:obj")));
        RDFMemoryStore store2 = store[c: new RDFContext("ex:ctx1")];
    ...
    public void ShouldSelectQuadruplesBySubjectAccessor()
    {
        ...
        store.AddQuadruple(new RDFQuadruple(new RDFContext("ex:ctx"), new RDFResource("ex:subj2"), new RDFResource("ex:pred"), new RDFResource("ex:obj")));
        RDFMemoryStore store2 = store[s: new RDFResource("ex:subj1")];
    ...
    public void ShouldNotSelectQuadruplesBySubjectAccessor()
    {
        ...
        store.AddQuadruple(new RDFQuadruple(new RDFContext("ex:ctx"), new RDFResource("ex:subj1"), new RDFResource("ex:pred"), new RDFPlainLiteral("lit")));
        store.AddQuadruple(new RDFQuadruple(new RDFContext("ex:ctx"), new RDFResource("ex:subj2"), new RDFResource("ex:pred"), new RDFResource("ex:obj")));
        RDFMemoryStore store2 = store[s: new RDFResource("ex:subj3")];
    ...
    public void ShouldSelectQuadruplesByPredicateAccessor()
    {
        ...
        store.AddQuadruple(new RDFQuadruple(new RDFContext("ex:ctx"), new RDFResource("ex:subj"), new RDFResource("ex:pred2"), new RDFResource("ex:obj")));
        RDFMemoryStore store2 = store[p: new RDFResource("ex:pred1")];
    ...
    public void ShouldNotSelectQuadruplesByPredicateAccessor()
    {
        ...
        store.AddQuadruple(new RDFQuadruple(new RDFContext("ex:ctx"), new RDFResource("ex:subj"), new RDFResource("ex:pred1"), new RDFPlainLiteral("lit")));
        store.AddQuadruple(new RDFQuadruple(new RDFContext("ex:ctx"), new RDFResource("ex:subj"), new RDFResource("ex:pred2"), new RDFResource("ex:obj")));
        RDFMemoryStore store2 = store[p: new RDFResource("ex:pred3")];
    ...
    public void ShouldSelectQuadruplesByObjectAccessor()
    {
        ...
        store.AddQuadruple(new RDFQuadruple(new RDFContext("ex:ctx"), new RDFResource("ex:subj"), new RDFResource("ex:pred"), new RDFPlainLiteral("lit")));
        store.AddQuadruple(new RDFQuadruple(new RDFContext("ex:ctx"), new RDFResource("ex:subj"), new RDFResource("ex:pred"), new RDFResource("ex:obj")));
        RDFMemoryStore store2 = store[o: new RDFResource("ex:obj")];
    ...
    public void ShouldNotSelectQuadruplesByObjectAccessor()
    {
        ...
        store.AddQuadruple(new RDFQuadruple(new RDFContext("ex:ctx"), new RDFResource("ex:subj"), new RDFResource("ex:pred"), new RDFPlainLiteral("lit")));
        store.AddQuadruple(new RDFQuadruple(new RDFContext("ex:ctx"), new RDFResource("ex:subj"), new RDFResource("ex:pred"), new RDFResource("ex:obj")));
        RDFMemoryStore store2 = store[o: new RDFResource("ex:obj3")];
    ...
    public void ShouldSelectQuadruplesByLiteralAccessor()
    {
        ...
        store.AddQuadruple(new RDFQuadruple(new RDFContext("ex:ctx"), new RDFResource("ex:subj"), new RDFResource("ex:pred"), new RDFPlainLiteral("lit")));
        store.AddQuadruple(new RDFQuadruple(new RDFContext("ex:ctx"), new RDFResource("ex:subj"), new RDFResource("ex:pred"), new RDFResource("ex:obj")));
        RDFMemoryStore store2 = store[l: new RDFPlainLiteral("lit")];
    ...
    public void ShouldNotSelectQuadruplesByLiteralAccessor()
    {
        ...
        store.AddQuadruple(new RDFQuadruple(new RDFContext("ex:ctx"), new RDFResource("ex:subj"), new RDFResource("ex:pred"), new RDFPlainLiteral("lit")));
        store.AddQuadruple(new RDFQuadruple(new RDFContext("ex:ctx"), new RDFResource("ex:subj"), new RDFResource("ex:pred"), new RDFResource("ex:obj")));
        RDFMemoryStore store2 = store[l: new RDFPlainLiteral("lit","en")];
    ...
    public void ShouldSelectQuadruplesByFullAccessor()
    {
        ...
        store.AddQuadruple(new RDFQuadruple(new RDFContext("ex:ctx1"), new RDFResource("ex:subj"), new RDFResource("ex:pred"), new RDFPlainLiteral("lit")));
        store.AddQuadruple(new RDFQuadruple(new RDFContext("ex:ctx2"), new RDFResource("ex:subj"), new RDFResource("ex:pred"), new RDFResource("ex:obj")));
        RDFMemoryStore store2 = store[c: new RDFContext("ex:ctx2"), s: new RDFResource("ex:subj"), p: new RDFResource("ex:pred"), o: new RDFResource("ex:obj")];
    ...
    public void ShouldNotSelectQuadruplesByFullAccessor()
    {
        ...
        store.AddQuadruple(new RDFQuadruple(new RDFContext("ex:ctx1"), new RDFResource("ex:subj"), new RDFResource("ex:pred"), new RDFPlainLiteral("lit")));
        store.AddQuadruple(new RDFQuadruple(new RDFContext("ex:ctx2"), new RDFResource("ex:subj"), new RDFResource("ex:pred"), new RDFResource("ex:obj")));
        RDFMemoryStore store2 = store[c: new RDFContext("ex:ctx1"), s: new RDFResource("ex:subj2"), p: new RDFResource("ex:pred"), o: new RDFResource("ex:obj")];
    ...
    [TestMethod]
    public void ShouldThrowExceptionOnSelectingQuadruplesByInvalidAccessor()
    {
        RDFMemoryStore store = new RDFMemoryStore();
        store.AddQuadruple(new RDFQuadruple(new RDFContext("ex:ctx1"), new RDFResource("ex:subj"), new RDFResource("ex:pred"), new RDFPlainLiteral("lit")));
        store.AddQuadruple(new RDFQuadruple(new RDFContext("ex:ctx2"), new RDFResource("ex:subj"), new RDFResource("ex:pred"), new RDFResource("ex:obj")));

        Assert.ThrowsExactly<RDFStoreException>(() => _ = store[o: new RDFResource("http://obj/"), l: new RDFPlainLiteral("lit")]);
    }
    ...
    public void ShouldImportFromDataTableHavingRowWithNullContext()
    {
        ...
        Assert.IsNotNull(store);
        Assert.AreEqual(1, store.QuadruplesCount);
        Assert.AreEqual(1, store[c: new RDFContext(), new RDFResource("http://subj/"), new RDFResource("http://pred/"), new RDFResource("http://obj/")].QuadruplesCount);
    }
    ...
    public void ShouldImportFromDataTableHavingRowWithValorizedContext()
    {
        ...
        Assert.IsNotNull(store);
        Assert.AreEqual(1, store.QuadruplesCount);
        Assert.AreEqual(1, store[c: new RDFContext("http://ctx/"), new RDFResource("http://subj/"), new RDFResource("http://pred/"), new RDFResource("http://obj/")].QuadruplesCount);
    }
