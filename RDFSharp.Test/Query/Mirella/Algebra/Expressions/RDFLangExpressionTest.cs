...
public class RDFLangExpressionTest
{
    ...
    public void ShouldCreateLangExpressionWithExpression()
    {
        ...
        Assert.IsTrue(expression.ToString().Equals("(LANG((?V1 + ?V2)))", System.StringComparison.Ordinal));
        Assert.IsTrue(expression.ToString([]).Equals("(LANG((?V1 + ?V2)))", System.StringComparison.Ordinal));
    }
    ...
    public void ShouldCreateLangExpressionWithVariable()
    {
        ...
        Assert.IsNotNull(expression.LeftArgument);
        Assert.IsNull(expression.RightArgument);
        Assert.IsTrue(expression.ToString().Equals("(LANG(?V1))", System.StringComparison.Ordinal));
        Assert.IsTrue(expression.ToString([]).Equals("(LANG(?V1))", System.StringComparison.Ordinal));
    }
