...
public class RDFStartsExpressionTest
{
    ...
    public void ShouldThrowExceptionOnCreatingEEStartsExpressionBecauseNullLeftArgument()
        => Assert.ThrowsExactly<RDFQueryException>(() => new RDFStartsExpression(null as RDFExpression, new RDFVariableExpression(new RDFVariable("?V"))));

    [TestMethod]
    public void ShouldThrowExceptionOnCreatingEVStartsExpressionBecauseNullLeftArgument()
        => Assert.ThrowsExactly<RDFQueryException>(() => new RDFStartsExpression(null as RDFExpression, new RDFVariable("?V")));

    [TestMethod]
    public void ShouldThrowExceptionOnCreatingVEStartsExpressionBecauseNullLeftArgument()
        => Assert.ThrowsExactly<RDFQueryException>(() => new RDFStartsExpression(null as RDFVariable, new RDFVariableExpression(new RDFVariable("?V"))));

    [TestMethod]
    public void ShouldThrowExceptionOnCreatingVVStartsExpressionNullLeftArgument()
        => Assert.ThrowsExactly<RDFQueryException>(() => new RDFStartsExpression(null as RDFVariable, new RDFVariable("?V")));
