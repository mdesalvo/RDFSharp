...
namespace RDFSharp.Test.Query
{
    ...
    public class RDFSubtractExpressionTest
    {
        #region Tests
        [TestMethod]
        public void ShouldCreateSubtractExpressionWithVariables()
        {
            RDFSubtractExpression expression = new RDFSubtractExpression(new RDFVariable("?L"), new RDFVariable("?R"));
        ...
        [TestMethod]
        public void ShouldCreateSubtractExpressionWithVariableAndTypedLiteral()
        {
            RDFSubtractExpression expression = new RDFSubtractExpression(new RDFVariable("?L"), new RDFTypedLiteral("25.1", RDFModelEnums.RDFDatatypes.XSD_DOUBLE));
        ...
        [TestMethod]
        public void ShouldThrowExceptionOnCreatingSubtractExpressionWithVariablesBecauseNullLeftArgument()
            => Assert.ThrowsException<RDFQueryException>(() => new RDFSubtractExpression(null, new RDFVariable("?R")));

        [TestMethod]
        public void ShouldThrowExceptionOnCreatingSubtractExpressionWithVariableAndTypedLiteralBecauseNullLeftArgument()
            => Assert.ThrowsException<RDFQueryException>(() => new RDFSubtractExpression(null, new RDFTypedLiteral("25", RDFModelEnums.RDFDatatypes.XSD_INTEGER)));

        [TestMethod]
        public void ShouldThrowExceptionOnCreatingSubtractExpressionWithVariablesBecauseNullRightArgument()
            => Assert.ThrowsException<RDFQueryException>(() => new RDFSubtractExpression(new RDFVariable("?L"), null as RDFVariable));

        [TestMethod]
        public void ShouldThrowExceptionOnCreatingSubtractExpressionWithVariableandTypedLiteralBecauseNullRightArgument()
            => Assert.ThrowsException<RDFQueryException>(() => new RDFSubtractExpression(new RDFVariable("?L"), null as RDFTypedLiteral));

        [TestMethod]
        public void ShouldThrowExceptionOnCreatingSubtractExpressionWithVariableandTypedLiteralBecauseNonNumericRightArgument()
            => Assert.ThrowsException<RDFQueryException>(() => new RDFSubtractExpression(new RDFVariable("?L"), new RDFTypedLiteral("23", RDFModelEnums.RDFDatatypes.XSD_GDAY)));
