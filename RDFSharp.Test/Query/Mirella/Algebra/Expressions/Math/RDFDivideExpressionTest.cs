...
namespace RDFSharp.Test.Query
{
    ...
    public class RDFDivideExpressionTest
    {
        ...
        {
            RDFDivideExpression expression = new RDFDivideExpression(new RDFVariable("?L"), new RDFVariable("?R"));
        ...
        {
            RDFDivideExpression expression = new RDFDivideExpression(new RDFVariable("?L"), new RDFTypedLiteral("25.1", RDFModelEnums.RDFDatatypes.XSD_DOUBLE));
        ...
        [TestMethod]
        public void ShouldThrowExceptionOnCreatingDivideExpressionWithVariablesBecauseNullLeftArgument()
            => Assert.ThrowsException<RDFQueryException>(() => new RDFDivideExpression(null, new RDFVariable("?R")));

        [TestMethod]
        public void ShouldThrowExceptionOnCreatingDivideExpressionWithVariableAndTypedLiteralBecauseNullLeftArgument()
            => Assert.ThrowsException<RDFQueryException>(() => new RDFDivideExpression(null, new RDFTypedLiteral("25", RDFModelEnums.RDFDatatypes.XSD_INTEGER)));

        [TestMethod]
        public void ShouldThrowExceptionOnCreatingDivideExpressionWithVariablesBecauseNullRightArgument()
            => Assert.ThrowsException<RDFQueryException>(() => new RDFDivideExpression(new RDFVariable("?L"), null as RDFVariable));

        [TestMethod]
        public void ShouldThrowExceptionOnCreatingDivideExpressionWithVariableandTypedLiteralBecauseNullRightArgument()
            => Assert.ThrowsException<RDFQueryException>(() => new RDFDivideExpression(new RDFVariable("?L"), null as RDFTypedLiteral));

        [TestMethod]
        public void ShouldThrowExceptionOnCreatingDivideExpressionWithVariableandTypedLiteralBecauseNonNumericRightArgument()
            => Assert.ThrowsException<RDFQueryException>(() => new RDFDivideExpression(new RDFVariable("?L"), new RDFTypedLiteral("23", RDFModelEnums.RDFDatatypes.XSD_GDAY)));
        ...
        public void ShouldApplyExpressionWithVariablesAndCalculateResult()
        {
            ...
            Assert.IsTrue(expressionResult.Equals(new RDFTypedLiteral("0.204", RDFModelEnums.RDFDatatypes.XSD_DOUBLE)));
        }
        ...
        [TestMethod]
        public void ShouldApplyExpressionWithVariablesAndNotCalculateResultBecauseTypedLiteralZeroRightColumn()
        {
            DataTable table = new DataTable();
            table.Columns.Add("?A", typeof(string));
            table.Columns.Add("?B", typeof(string));
            DataRow row = table.NewRow();
            row["?A"] = new RDFTypedLiteral("25", RDFModelEnums.RDFDatatypes.XSD_INT).ToString();
            row["?B"] = new RDFTypedLiteral("0", RDFModelEnums.RDFDatatypes.XSD_DOUBLE).ToString();
            table.Rows.Add(row);
            table.AcceptChanges();
