...
namespace RDFSharp.Test.Query
{
    ...
    public class RDFMultiplyExpressionTest
    {
        ...
        {
            RDFMultiplyExpression expression = new RDFMultiplyExpression(new RDFVariable("?L"), new RDFVariable("?R"));
        ...
        {
            RDFMultiplyExpression expression = new RDFMultiplyExpression(new RDFVariable("?L"), new RDFTypedLiteral("25.1", RDFModelEnums.RDFDatatypes.XSD_DOUBLE));
        ...
        [TestMethod]
        public void ShouldThrowExceptionOnCreatingMultiplyExpressionWithVariablesBecauseNullLeftArgument()
            => Assert.ThrowsException<RDFQueryException>(() => new RDFMultiplyExpression(null, new RDFVariable("?R")));

        [TestMethod]
        public void ShouldThrowExceptionOnCreatingMultiplyExpressionWithVariableAndTypedLiteralBecauseNullLeftArgument()
            => Assert.ThrowsException<RDFQueryException>(() => new RDFMultiplyExpression(null, new RDFTypedLiteral("25", RDFModelEnums.RDFDatatypes.XSD_INTEGER)));

        [TestMethod]
        public void ShouldThrowExceptionOnCreatingMultiplyExpressionWithVariablesBecauseNullRightArgument()
            => Assert.ThrowsException<RDFQueryException>(() => new RDFMultiplyExpression(new RDFVariable("?L"), null as RDFVariable));

        [TestMethod]
        public void ShouldThrowExceptionOnCreatingMultiplyExpressionWithVariableandTypedLiteralBecauseNullRightArgument()
            => Assert.ThrowsException<RDFQueryException>(() => new RDFMultiplyExpression(new RDFVariable("?L"), null as RDFTypedLiteral));

        [TestMethod]
        public void ShouldThrowExceptionOnCreatingMultiplyExpressionWithVariableandTypedLiteralBecauseNonNumericRightArgument()
            => Assert.ThrowsException<RDFQueryException>(() => new RDFMultiplyExpression(new RDFVariable("?L"), new RDFTypedLiteral("23", RDFModelEnums.RDFDatatypes.XSD_GDAY)));
        ...
        public void ShouldApplyExpressionWithVariablesAndCalculateResult()
        {
            ...
            row["?A"] = new RDFTypedLiteral("5.12", RDFModelEnums.RDFDatatypes.XSD_DOUBLE).ToString();
            ...
            Assert.IsTrue(expressionResult.Equals(new RDFTypedLiteral("128", RDFModelEnums.RDFDatatypes.XSD_DOUBLE)));
        }
