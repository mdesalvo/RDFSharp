...
public class RDFSameTermExpressionTest
{
    ...
    public void ShouldApplyExpressionWithVVAndCalculateResult()
    {
        ...
        table.Columns.Add("?B", typeof(string));
        DataRow row = table.NewRow();
        row["?A"] = new RDFTypedLiteral("hello", RDFModelEnums.RDFDatatypes.XSD_STRING);
        row["?B"] = new RDFTypedLiteral("hello", RDFModelEnums.RDFDatatypes.XSD_STRING);
        table.Rows.Add(row);
        table.AcceptChanges();
    ...
    public void ShouldApplyExpressionWithEEAndCalculateResultFalse()
    {
        ...
        row["?B"] = new RDFPlainLiteral("HELO");
        table.Rows.Add(row);
        table.AcceptChanges();
