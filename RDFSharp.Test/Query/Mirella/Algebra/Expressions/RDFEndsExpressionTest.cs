...
namespace RDFSharp.Test.Query
{
    ...
    public class RDFEndsExpressionTest
    {
        ...
        public void ShouldCreateVEEndsExpression()
        {
            ...
            Assert.IsTrue(expression.ToString(new List<RDFNamespace>()).Equals("(STRENDS(?V3, (?V1 + ?V2)))"));
        }
        ...
        public void ShouldCreateVVEndsExpression()
        {
            ...
            Assert.IsTrue(expression.ToString(new List<RDFNamespace>()).Equals("(STRENDS(?V3, ?V1))"));
        }
