...
namespace RDFSharp.Test.Query
{
    ...
    public class RDFContainsExpressionTest
    {
        ...
        public void ShouldCreateEEContainsExpression1()
        {
            ...
            Assert.IsTrue(expression.ToString(new List<RDFNamespace>()).Equals("(CONTAINS((?V1 + ?V2), ?V3))"));
        }
        ...
        public void ShouldCreateEEContainsExpression2()
        {
            ...
            Assert.IsTrue(expression.ToString(new List<RDFNamespace>()).Equals($"(CONTAINS((?V1 + ?V2), \"hello\"^^<{RDFVocabulary.XSD.STRING}>))"));
            Assert.IsTrue(expression.ToString(new List<RDFNamespace>() { RDFNamespaceRegister.GetByPrefix("xsd") }).Equals("(CONTAINS((?V1 + ?V2), \"hello\"^^xsd:string))"));
        }
        ...
        public void ShouldCreateEEContainsExpressionNested()
        {
            ...
            Assert.IsTrue(expression.ToString(new List<RDFNamespace>()).Equals("(CONTAINS((?V1 + ?V2), (CONTAINS(?V3, \"hello\"@EN-US))))"));
        }
        ...
        public void ShouldCreateVEContainsExpression()
        {
            ...
            Assert.IsTrue(expression.ToString(new List<RDFNamespace>()).Equals("(CONTAINS(?V3, (?V1 + ?V2)))"));
        }
        ...
        public void ShouldCreateVVContainsExpression()
        {
            ...
            Assert.IsTrue(expression.ToString(new List<RDFNamespace>()).Equals("(CONTAINS(?V3, ?V1))"));
        }
