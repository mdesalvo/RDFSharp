...
public class RDFLangDirExpressionTest
{
    ...
    public void ShouldCreateLangDirExpressionWithExpression()
    {
        ...
        Assert.IsTrue(expression.ToString().Equals("(LANGDIR((?V1 + ?V2)))", System.StringComparison.Ordinal));
        Assert.IsTrue(expression.ToString([]).Equals("(LANGDIR((?V1 + ?V2)))", System.StringComparison.Ordinal));
    }
    ...
    public void ShouldCreateLangDirExpressionWithVariable()
    {
        ...
        Assert.IsNotNull(expression.LeftArgument);
        Assert.IsNull(expression.RightArgument);
        Assert.IsTrue(expression.ToString().Equals("(LANGDIR(?V1))", System.StringComparison.Ordinal));
        Assert.IsTrue(expression.ToString([]).Equals("(LANGDIR(?V1))", System.StringComparison.Ordinal));
    }
