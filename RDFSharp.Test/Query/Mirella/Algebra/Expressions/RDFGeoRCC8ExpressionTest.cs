...
namespace RDFSharp.Test.Query
{
    ...
    public class RDFGeoRCC8ExpressionTest
    {
        ...
        public void ShouldCreateGEORCC8ExpressionWithExpressions()
        {
            ...
            Assert.IsTrue(expression.ToString(new List<RDFNamespace>() { RDFNamespaceRegister.GetByPrefix("geof"), RDFNamespaceRegister.GetByPrefix("geosparql") }).Equals("(geof:rcc8dc(?V, \"POINT (1 1)\"^^geosparql:wktLiteral))"));
        }
        ...
        public void ShouldCreateGEORCC8ExpressionWithExpressionAndVariable()
        {
            ...
            Assert.IsTrue(expression.ToString(new List<RDFNamespace>() { RDFNamespaceRegister.GetByPrefix("geof"), RDFNamespaceRegister.GetByPrefix("geosparql") }).Equals("(geof:rcc8ec(\"POINT (1 1)\"^^geosparql:wktLiteral, ?V))"));
        }
        ...
        public void ShouldCreateGEORCC8ExpressionWithExpressionAndTypedLiteral()
        {
            ...
            Assert.IsTrue(expression.ToString(new List<RDFNamespace>() { RDFNamespaceRegister.GetByPrefix("geof"), RDFNamespaceRegister.GetByPrefix("geosparql") }).Equals("(geof:rcc8eq(\"POINT (2 2)\"^^geosparql:wktLiteral, \"POINT (1 1)\"^^geosparql:wktLiteral))"));
        }
        ...
        public void ShouldCreateGEORCC8ExpressionWithVariableAndExpression()
        {
            ...
            Assert.IsTrue(expression.ToString(new List<RDFNamespace>() { RDFNamespaceRegister.GetByPrefix("geof"), RDFNamespaceRegister.GetByPrefix("geosparql") }).Equals("(geof:rcc8ntpp(?V, \"POINT (1 1)\"^^geosparql:wktLiteral))"));
        }
        ...
        public void ShouldCreateGEORCC8ExpressionWithVariables()
        {
            ...
            Assert.IsTrue(expression.ToString(new List<RDFNamespace>() { RDFNamespaceRegister.GetByPrefix("geof"), RDFNamespaceRegister.GetByPrefix("geosparql") }).Equals("(geof:rcc8ntppi(?V1, ?V2))"));
        }
        ...
        public void ShouldCreateGEORCC8ExpressionWithVariableAndTypedLiteral1()
        {
            ...
            Assert.IsTrue(expression.ToString(new List<RDFNamespace>() { RDFNamespaceRegister.GetByPrefix("geof"), RDFNamespaceRegister.GetByPrefix("geosparql") }).Equals("(geof:rcc8po(?V, \"POINT (1 1)\"^^geosparql:wktLiteral))"));
        }
        ...
        public void ShouldCreateGEORCC8ExpressionWithVariableAndTypedLiteral2()
        {
            ...
            Assert.IsTrue(expression.ToString(new List<RDFNamespace>() { RDFNamespaceRegister.GetByPrefix("geof"), RDFNamespaceRegister.GetByPrefix("geosparql") }).Equals("(geof:rcc8tpp(?V, \"POINT (1 1)\"^^geosparql:wktLiteral))"));
        }
        ...
        public void ShouldCreateGEORCC8ExpressionWithVariableAndTypedLiteral3()
        {
            ...
            Assert.IsTrue(expression.ToString(new List<RDFNamespace>() { RDFNamespaceRegister.GetByPrefix("geof"), RDFNamespaceRegister.GetByPrefix("geosparql") }).Equals("(geof:rcc8tppi(?V, \"POINT (1 1)\"^^geosparql:wktLiteral))"));
        }

        [TestMethod]
        public void ShouldThrowExceptionOnCreatingGEORCC8ExpressionWithEEBecauseNullLeftArgument()
            => Assert.ThrowsException<RDFQueryException>(() => new RDFGeoRCC8Expression(null as RDFVariableExpression, new RDFVariableExpression(new RDFVariable("?V")), RDFQueryEnums.RDFGeoRCC8Relations.RCC8DC));

        [TestMethod]
        public void ShouldThrowExceptionOnCreatingGEORCC8ExpressionWithEEBecauseNullRightArgument()
            => Assert.ThrowsException<RDFQueryException>(() => new RDFGeoRCC8Expression(new RDFVariableExpression(new RDFVariable("?V")), null as RDFVariableExpression, RDFQueryEnums.RDFGeoRCC8Relations.RCC8DC));

        [TestMethod]
        public void ShouldThrowExceptionOnCreatingGEORCC8ExpressionWithEVBecauseNullLeftArgument()
            => Assert.ThrowsException<RDFQueryException>(() => new RDFGeoRCC8Expression(null as RDFVariableExpression, new RDFVariable("?V"), RDFQueryEnums.RDFGeoRCC8Relations.RCC8DC));

        [TestMethod]
        public void ShouldThrowExceptionOnCreatingGEORCC8ExpressionWithEVBecauseNullRightArgument()
            => Assert.ThrowsException<RDFQueryException>(() => new RDFGeoRCC8Expression(new RDFVariableExpression(new RDFVariable("?V")), null as RDFVariable, RDFQueryEnums.RDFGeoRCC8Relations.RCC8DC));

        [TestMethod]
        public void ShouldThrowExceptionOnCreatingGEORCC8ExpressionWithETBecauseNullLeftArgument()
            => Assert.ThrowsException<RDFQueryException>(() => new RDFGeoRCC8Expression(null as RDFVariableExpression, new RDFTypedLiteral("POINT (1 1)", RDFModelEnums.RDFDatatypes.GEOSPARQL_WKT), RDFQueryEnums.RDFGeoRCC8Relations.RCC8DC));

        [TestMethod]
        public void ShouldThrowExceptionOnCreatingGEORCC8ExpressionWithETBecauseNullRightArgument()
            => Assert.ThrowsException<RDFQueryException>(() => new RDFGeoRCC8Expression(new RDFVariableExpression(new RDFVariable("?V")), null as RDFTypedLiteral, RDFQueryEnums.RDFGeoRCC8Relations.RCC8DC));

        [TestMethod]
        public void ShouldThrowExceptionOnCreatingGEORCC8ExpressionWithETBecauseNotGeographicRightArgument()
            => Assert.ThrowsException<RDFQueryException>(() => new RDFGeoRCC8Expression(new RDFVariableExpression(new RDFVariable("?V")), new RDFTypedLiteral("Hello", RDFModelEnums.RDFDatatypes.XSD_STRING), RDFQueryEnums.RDFGeoRCC8Relations.RCC8DC));

        [TestMethod]
        public void ShouldThrowExceptionOnCreatingGEORCC8ExpressionWithVEBecauseNullLeftArgument()
            => Assert.ThrowsException<RDFQueryException>(() => new RDFGeoRCC8Expression(null as RDFVariable, new RDFVariableExpression(new RDFVariable("?V")), RDFQueryEnums.RDFGeoRCC8Relations.RCC8DC));

        [TestMethod]
        public void ShouldThrowExceptionOnCreatingGEORCC8ExpressionWithVEBecauseNullRightArgument()
            => Assert.ThrowsException<RDFQueryException>(() => new RDFGeoRCC8Expression(new RDFVariable("?V"), null as RDFVariableExpression, RDFQueryEnums.RDFGeoRCC8Relations.RCC8DC));

        [TestMethod]
        public void ShouldThrowExceptionOnCreatingGEORCC8ExpressionWithVVBecauseNullLeftArgument()
            => Assert.ThrowsException<RDFQueryException>(() => new RDFGeoRCC8Expression(null as RDFVariable, new RDFVariable("?V"), RDFQueryEnums.RDFGeoRCC8Relations.RCC8DC));

        [TestMethod]
        public void ShouldThrowExceptionOnCreatingGEORCC8ExpressionWithVVBecauseNullRightArgument()
            => Assert.ThrowsException<RDFQueryException>(() => new RDFGeoRCC8Expression(new RDFVariable("?V"), null as RDFVariable, RDFQueryEnums.RDFGeoRCC8Relations.RCC8DC));

        [TestMethod]
        public void ShouldThrowExceptionOnCreatingGEORCC8ExpressionWithVTBecauseNullLeftArgument()
            => Assert.ThrowsException<RDFQueryException>(() => new RDFGeoRCC8Expression(null as RDFVariable, new RDFTypedLiteral("POINT (1 1)", RDFModelEnums.RDFDatatypes.GEOSPARQL_WKT), RDFQueryEnums.RDFGeoRCC8Relations.RCC8DC));

        [TestMethod]
        public void ShouldThrowExceptionOnCreatingGEORCC8ExpressionWithVTBecauseNullRightArgument()
            => Assert.ThrowsException<RDFQueryException>(() => new RDFGeoRCC8Expression(new RDFVariable("?V"), null as RDFTypedLiteral, RDFQueryEnums.RDFGeoRCC8Relations.RCC8DC));

        [TestMethod]
        public void ShouldThrowExceptionOnCreatingGEORCC8ExpressionWithVTBecauseNotGeographicRightArgument()
            => Assert.ThrowsException<RDFQueryException>(() => new RDFGeoRCC8Expression(new RDFVariable("?V"), new RDFTypedLiteral("Hello", RDFModelEnums.RDFDatatypes.XSD_STRING), RDFQueryEnums.RDFGeoRCC8Relations.RCC8DC));
