...
namespace RDFSharp.Test.Query
{
    ...
    public class RDFGeoUnionExpressionTest
    {
        ...
        public void ShouldCreateGEOUnionExpressionWithExpressions()
        {
            ...
            Assert.IsTrue(expression.ToString(new List<RDFNamespace>() { RDFNamespaceRegister.GetByPrefix("geof"), RDFNamespaceRegister.GetByPrefix("geosparql") }).Equals("(geof:union(?V, \"POINT (1 1)\"^^geosparql:wktLiteral))"));
        }
        ...
        public void ShouldCreateGEOUnionExpressionWithExpressionAndVariable()
        {
            ...
            Assert.IsTrue(expression.ToString(new List<RDFNamespace>() { RDFNamespaceRegister.GetByPrefix("geof"), RDFNamespaceRegister.GetByPrefix("geosparql") }).Equals("(geof:union(\"POINT (1 1)\"^^geosparql:wktLiteral, ?V))"));
        }
        ...
        public void ShouldCreateGEOUnionExpressionWithExpressionAndTypedLiteral()
        {
            ...
            Assert.IsTrue(expression.ToString(new List<RDFNamespace>() { RDFNamespaceRegister.GetByPrefix("geof"), RDFNamespaceRegister.GetByPrefix("geosparql") }).Equals("(geof:union(\"POINT (2 2)\"^^geosparql:wktLiteral, \"POINT (1 1)\"^^geosparql:wktLiteral))"));
        }
        ...
        public void ShouldCreateGEOUnionExpressionWithVariables()
        {
            ...
            Assert.IsTrue(expression.ToString(new List<RDFNamespace>() { RDFNamespaceRegister.GetByPrefix("geof"), RDFNamespaceRegister.GetByPrefix("geosparql") }).Equals("(geof:union(?V1, ?V2))"));
        }
