...
public class RDFHoursExpressionTest
{
    ...
    public void ShouldCreateHoursExpressionWithExpression()
    {
        ...
        Assert.IsTrue(expression.ToString().Equals("(HOURS((?V1 + ?V2)))", System.StringComparison.Ordinal));
        Assert.IsTrue(expression.ToString([]).Equals("(HOURS((?V1 + ?V2)))", System.StringComparison.Ordinal));
    }
    ...
    public void ShouldCreateHoursExpressionWithVariable()
    {
        ...
        Assert.IsNotNull(expression.LeftArgument);
        Assert.IsNull(expression.RightArgument);
        Assert.IsTrue(expression.ToString().Equals("(HOURS(?V1))", System.StringComparison.Ordinal));
        Assert.IsTrue(expression.ToString([]).Equals("(HOURS(?V1))", System.StringComparison.Ordinal));
    }
