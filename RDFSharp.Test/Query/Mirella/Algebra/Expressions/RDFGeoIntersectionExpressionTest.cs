...
namespace RDFSharp.Test.Query
{
    ...
    public class RDFGeoIntersectionExpressionTest
    {
        ...
        public void ShouldCreateGEOIntersectionExpressionWithExpressions()
        {
            ...
            Assert.IsTrue(expression.ToString([RDFNamespaceRegister.GetByPrefix("geof"), RDFNamespaceRegister.GetByPrefix("geosparql")]).Equals("(geof:intersection(?V, \"POINT (1 1)\"^^geosparql:wktLiteral))"));
        }
        ...
        public void ShouldCreateGEOIntersectionExpressionWithExpressionAndVariable()
        {
            ...
            Assert.IsTrue(expression.ToString([RDFNamespaceRegister.GetByPrefix("geof"), RDFNamespaceRegister.GetByPrefix("geosparql")]).Equals("(geof:intersection(\"POINT (1 1)\"^^geosparql:wktLiteral, ?V))"));
        }
        ...
        public void ShouldCreateGEOIntersectionExpressionWithExpressionAndTypedLiteral()
        {
            ...
            Assert.IsTrue(expression.ToString([RDFNamespaceRegister.GetByPrefix("geof"), RDFNamespaceRegister.GetByPrefix("geosparql")]).Equals("(geof:intersection(\"POINT (2 2)\"^^geosparql:wktLiteral, \"POINT (1 1)\"^^geosparql:wktLiteral))"));
        }
        ...
        public void ShouldCreateGEOIntersectionExpressionWithVariables()
        {
            ...
            Assert.IsTrue(expression.ToString([RDFNamespaceRegister.GetByPrefix("geof"), RDFNamespaceRegister.GetByPrefix("geosparql")]).Equals("(geof:intersection(?V1, ?V2))"));
        }
