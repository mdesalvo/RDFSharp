...
public class RDFCeilExpressionTest
{
    ...
    public void ShouldCreateCeilExpressionWithExpression()
    {
        ...
        Assert.IsTrue(expression.ToString().Equals("(CEIL((?V1 + ?V2)))", System.StringComparison.Ordinal));
        Assert.IsTrue(expression.ToString([]).Equals("(CEIL((?V1 + ?V2)))", System.StringComparison.Ordinal));
    }
    ...
    public void ShouldCreateCeilExpressionWithVariable()
    {
        ...
        Assert.IsNotNull(expression.LeftArgument);
        Assert.IsNull(expression.RightArgument);
        Assert.IsTrue(expression.ToString().Equals("(CEIL(?V1))", System.StringComparison.Ordinal));
        Assert.IsTrue(expression.ToString([]).Equals("(CEIL(?V1))", System.StringComparison.Ordinal));
    }
