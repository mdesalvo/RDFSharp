...
<ul>
    ...
    <ul>
        ...
        <li>Create and process <i>SHACL shapes</i> (shape graphs, shapes, targets, constraints, reports, ...) <b>--> In Progress (38%)</b></li>
    </ul>
</ul>
<ul>
    <li><b>RDFSharp.Store</b></li> 
    <ul>
        <li>Create and manage <i>RDF stores</i> for context-aware modeling of RDF data</li>
