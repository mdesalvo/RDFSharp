...
RDFSharp has a modular API made up of four layers ([RDF/SPARQL/SHACL docs](https://github.com/mdesalvo/RDFSharp/releases/download/v2.21.0/RDFSharp-2.21.0.pdf), [OWL/SKOS docs](https://github.com/mdesalvo/RDFSharp/releases/download/v2.21.0/RDFSharp.Semantics-2.21.0.pdf)): 
