...
RDFSharp has a modular API made up of four layers ([RDF/SPARQL docs](https://github.com/mdesalvo/RDFSharp/releases/download/v2.16.0/RDFSharp-2.16.0.pdf), [OWL docs](https://github.com/mdesalvo/RDFSharp/releases/download/v2.16.0/RDFSharp.Semantics-2.16.0.pdf)): 
