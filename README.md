...
<b><a href="https://github.com/mdesalvo/RDFSharp/releases/download/v3.4.0/RDFSharp.Model-3.4.0.pdf">RDFSharp.Model</a></b>
<ul>
...
<b><a href="https://github.com/mdesalvo/RDFSharp/releases/download/v3.4.0/RDFSharp.Store-3.4.0.pdf">RDFSharp.Store</a></b>
<ul>
...
<hr/>
An additional <a href="https://github.com/mdesalvo/RDFSharp.Semantics">layer</a> is also available for working in a powerful and expressive way with <b>OWL-DL ontologies</b>, along with its own set of <a href="https://github.com/mdesalvo/RDFSharp.Semantics.Extensions">extensions</a>. All of these transform RDFSharp into an amazing <b>geospatial</b> and <b>temporal</b> reasoning platform, suited for realizing every kind of idea.
